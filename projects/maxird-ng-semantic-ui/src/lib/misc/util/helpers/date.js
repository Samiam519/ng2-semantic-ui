...
exports.DateUtil = {
    ...
    next: function (precision, date) {
        return exports.DateUtil.add(precision, date, 1);
    },
    add: function (precision, date, i) {
        ...
        switch (precision) {
            ...
            case DatePrecision.Month:
                ...
                if (date.getMonth() !== util_1.Util.Math.mod(month + i, 12)) {
                    date.setDate(0);
                }
                break;
            case DatePrecision.Date:
    ...
    previous: function (precision, date) {
        ...
        switch (precision) {
            ...
            case DatePrecision.Month:
                ...
                if (date.getMonth() !== util_1.Util.Math.mod(month - 1, 12)) {
                    date.setDate(0);
                }
                break;
            case DatePrecision.Date:
            ...
            case DatePrecision.Hour:
                ...
                if (date.getHours() !== util_1.Util.Math.mod(hours - 1, 24)) {
