...
var tab_header_1 = require("../directives/tab-header");
var tab_content_1 = require("../directives/tab-content");
var tab_1 = require("../classes/tab");
var SuiTabset = /** @class */ (function () {
    ...
    SuiTabset.prototype.loadTabs = function () {
        ...
        this._tabHeaders
            ...
            var tab = new tab_1.Tab(tH, content);
    ...
    __decorate([
        core_1.ContentChildren(tab_header_1.SuiTabHeader)
    ], SuiTabset.prototype, "_tabHeaders", void 0);
    __decorate([
        core_1.ContentChildren(tab_content_1.SuiTabContent)
