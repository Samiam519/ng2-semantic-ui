...
var CalendarRangeHourService = /** @class */ (function (_super) {
    ...
    CalendarRangeHourService.prototype.configureItem = function (item, baseDate) {
        ...
        item.humanReadable = new date_parser_1.DateParser(customFormat, this.service.localeValues).format(item.date);
...
var SuiCalendarHourView = /** @class */ (function (_super) {
    ...
    function SuiCalendarHourView(renderer) {
        return _super.call(this, renderer, calendar_view_1.CalendarViewType.Hour, new CalendarRangeHourService(date_1.DatePrecision.Date, 6, 4)) || this;
    }
    Object.defineProperty(SuiCalendarHourView.prototype, "date", {
        get: function () {
            return new date_parser_1.DateParser(this.service.localeValues.formats.date, this.service.localeValues).format(this.currentDate);
        },
        enumerable: true,
        configurable: true
    });
